...
class TelasTransicao:
    ...
    # =========================================================================
    # MEIOS DE TRANSPORTE (Sua identidade visual preservada)
    # =========================================================================
    ...
    # =========================================================================
    # ENCONTROS INDISPENSÁVEIS DA HISTÓRIA
    # =========================================================================
    ...
    def mostrar_evento_veterano(self, imagem_fundo, comando_ouvir, comando_ignorar):
        ...
        if imagem_fundo:
            # 1. Recuperamos a imagem PIL original do objeto CTkImage
            # 2. Criamos um NOVO CTkImage com o tamanho exato da tela (1220, 700)
            # Nota: 'imagem_fundo' aqui é um objeto CTkImage. 
            # Acessamos o atributo interno 'light_image' para obter o objeto PIL.
    ...
    # =========================================================================
    # TELAS FINAIS (Sincronizadas com a sua nova main)
    # =========================================================================
    ...
    def mostrar_tela_desmaio(self, imagem_fundo, comando_continuar):
        ...
        if imagem_fundo:
            # 🔔 CORREÇÃO: Forçando o CTkLabel a ter exatamente o tamanho da janela (1220x700)
            ctk.CTkLabel(self.janela, width=1220, height=700, image=imagem_fundo, text="").place(x=0, y=0)
        else:
            ctk.CTkLabel(self.janela, width=1220, height=700, text="[💥 Você apagou de exaustão...]", font=("Segoe UI", 24)).place(x=0, y=0)
        
        # Sua caixa de texto com o botão continuar permanece idêntica por cima da foto
    ...
    def mostrar_game_over(self, motivo, imagem_fundo):
        ...
        if imagem_fundo:
            # 🔔 CORREÇÃO: Forçando o CTkLabel do Game Over a ter exatamente 1220x700
            ctk.CTkLabel(self.janela, width=1220, height=700, image=imagem_fundo, text="").place(x=0, y=0)
        else:
            ctk.CTkLabel(self.janela, width=1220, height=700, text="", fg_color="black").place(x=0, y=0)
        
        # Elementos de texto centralizados por cima do fundo cheia
